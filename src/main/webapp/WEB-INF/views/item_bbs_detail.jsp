...
<%@ include file="inc/top_navi.jsp"%>
	...
	<a href="${pageContext.request.contextPath}/item_bbs_add.do?wd=${output.product_prod_no}" id="ad">게시글 추가</a>
	<a href="${pageContext.request.contextPath}/item_bbs_edit.do?item_inq_no=${output.item_inq_no}" id="ed" class="hidbtn">글 수정</a>
	</div>
	<form action="${pageContext.request.contextPath}/item_bbs_delete_ok.do?item_inq_no=${output.item_inq_no}" id="fo">
	<input type="text" id="product_prod_no" name="product_prod_no" value="${output.product_prod_no}" style="display: none">
	<input type="text" id="item_inq_no" name="item_inq_no" value="${output.item_inq_no}" style="display: none">
