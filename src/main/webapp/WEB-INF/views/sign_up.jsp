...
<body>
 <%@ include file="inc/top_navi.jsp"%>
	<div id="container">
		...
		<form class="form-horizontal" name="join_form" id="join_form" onsubmit="return check()" method="post" action="${pageContext.request.contextPath}/sign_up_ok.do">
			<div class="form-group">
				...
				<div class="small_button">
					<button type="button" name="id_uniq_check" id="id_uniq_check" class="btn_action">중복확인</button>
				</div>
			...
			<div class="form-group">
				<div class="col-md-10">
					<input type="text" name="postcode" id="sample2_postcode"
			...
			<div id="input_address" class="form-group">
				...
				<div class="col-md-10">
					<input type="text" name="addr1" id="sample2_address"
			...
			<div id="input_detail_address" class="form-group">
				...
				<div class="col-md-10">
					<input type="text" name="addr2"
						id="sample2_detailAddress" class="form-control" placeholder="상세주소">
				</div>
			...
			<div id="last_btn" class="clear">
				...
				<button type="submit" id="submit" class="last_select">가입하기</button>
	...
	$(function() {
		...
		$("#id_uniq_check").click(function() {
			...
			if (!idReg.test($("input[name=user_id]").val())) {
				swal({
					title : "에러",
					text : "아이디는 영문자로 시작하는 4~20자의 영문자+숫자여야 합니다.",
					type : "error"
				});
				$("#user_id").focus();
				return false;
			...
			$.post("${pageContext.request.contextPath}/api/id_unique_check.do", {
				user_id : user_id_val
			}, function(req) {
				...
				if (req.result == 'OK') {
					...
					swal("에러","사용할 수 없는 아이디 입니다.", "error");
					$("#user_id").val("");
					$("#user_id").focus();
				}
			...
			jQuery.validator.setDefaults({
				...
				showErrors : function(errorMap, errorList) { // 에러 발생시 호출되는 함수 재정의
					...
					if (this.numberOfInvalids()) {
						...
						swal("회원가입완료", "로그인 페이지로 이동합니다.", "success");					
